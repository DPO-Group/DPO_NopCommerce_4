...
using Nop.Plugin.Payments.Dpo.Components;
    ...
    public class DpoPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                createXML.Append($"<CompanyRefUnique>1</CompanyRefUnique>");
                ...
                {
                    var initiateContent = new ByteArrayContent(Encoding.ASCII.GetBytes(createXML.ToString()));
                    var responseDpo = await client.PostAsync(dpoUrl, initiateContent);
...
<b>Open an Account:</b>
        ...
        {
            return typeof(PaymentDpoViewComponent);
        }
